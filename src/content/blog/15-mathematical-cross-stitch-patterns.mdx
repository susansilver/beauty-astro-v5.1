...
<Image src={dozenal} alt="Blue digits on white background from 0 to dek,el,do" format="avif" quality="mid" />
...
<ImageAlign imagePath="/src/assets/Godfrey_Harold_Hardy_1.jpg" alt="Photograph of G.H Hardy" caption="G.H Hardy" float="float-right" align="caption-right" style="width:50%;" />
...
<FancyBlockquote cite="G.H Hardy" name="mdi:book-open-variant">
...
<Image src={e} alt="The first hundred digits of e with each digit represented as different colored blue square" format="avif" quality="mid" />
...
<Image src={pi} alt="The first hundred digits of pi with each digit represented as different colored blue square" format="avif" quality="mid" />
...
<Image src={enigma} alt="Enigma spelled out in typewriter keys on a black background" format="avif" quality="mid" />
...
<Image src={porgy} alt="Teddy bear wearing blue overalls with red buttons on white background with Alan Turing's name in black" format="avif" quality="mid" />
...
<ImageAlign imagePath="/src/assets/alan-turing-teddybear-porgy-cross-stitch-pattern.png" alt="Alan Turing's Teddy Bear Porgy" caption="Alan Turing's Teddy Bear Porgy" align="caption-center" flex="justify-center" />
...
<Image src={twenty} alt="The number 220 in blue with a red heart with 284 on it with the factors of 284 around them in black" format="avif" quality="mid"/>
...
<Image src={two} alt="The number 284 in blue with a red heart with 220 on it with the factors of 284 around them in black" format="avif" quality="mid" />
...
<Image src={BaseTweleve} alt="This pattern for cross stitch features the digits of dozenal, also called Base 12 or duodecimal, in the color of royal blue with the digits dek, el, and do." format="avif" quality="mid" />
...
<Image src={edigits} alt="a large e in blue with its first few digits in black on a white background" format="avif" quality="mid" />
...
<Image src={pidigits} alt="Pi in Blue with the first few digits in black on a white background" format="avif" quality="mid" />
...
<Image src={alice} alt="the words curiouser and curiouser in cursive with black thread on a white background" format="avif" quality="mid" />
...
<Image src={haunts} alt="The phrase 999 Happy Haunts in green on a white background" format="avif" quality="mid" />
...
<Image src={ goddess} alt="The word Math Goddess in black on a white background" format="avif" quaity="mid" />
...
<Image src={erdos} alt="Erdos quote in black on a white background" format="avif" quality="mid" />
...
<Image src={golden} alt="Phi in blue with the first few digits in black on a white background" format="avif" quality="mid" />
...
<Image src={zork} alt="You are likely to be eaten by a grue in black on a white background" format="avif" quality="mid" />
