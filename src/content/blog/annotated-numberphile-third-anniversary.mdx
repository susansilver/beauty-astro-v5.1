...
Here is the playlist of the third anniversary videos. They are in order of publication date. The personal annotations are numbered by the video's position in the playlist for easy reference. You can [view this playlist on YouTube](https://www.youtube.com/playlist?list=PLLL_2f0y97l-4d3trZMXmTHhQxotaNOt2).
...
It was surprising to find this video. I've read about this research as [recently as last year](https://www.scientificamerican.com/article/scientists-destroy-illusion-that-coin-toss-flips-are-50-50/). It was based on a paper from the professor featured here, Persi Diaconis. This video is from 2015, but this reseracb by Diaconis [goes back to 2007](https://www.mercurynews.com/2009/10/16/heads-or-tails-it-depends-on-how-you-flip-it/).

It seems to be something that is being rediscovered. And then hits the news because of its unexpected results. It is cool to know that Diaconis is continuing this line of research even now in 2024.
...
I thought this was an interesting video in the series on infinities. This time about something infintiesimally small. In the next video, James Grime takes about [infinitesimals in relation to calculus](https://www.youtube.com/watch?v=WYijIV5JrKg). Even if they are no longer used because we have limits. It is an interesting part of math history still.
